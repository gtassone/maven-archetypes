...
import ${groupId}.util.jpa.JpaConstants;

public class Test${PersistenceUnitClass} {
	...
	public static void beforeClass() throws IOException, SQLException {
		...
		emf = Persistence.createEntityManagerFactory("${persistenceUnit}-test",
				props);
	...
	private static IDataSet getDataSet() throws MalformedURLException,
		...
		return builder.build(Test${PersistenceUnitClass}.class.getClassLoader()
	...
	private static Properties loadProperties() throws IOException {
		...
		properties.load(Test${PersistenceUnitClass}.class.getClassLoader()
