...
/**
 * In this class we want to test the functionality of our service DAOs. What
 * functionality should we test?
 * 
 * Persistence properties. Very similar at some level to our direct Entity
 * tests. We could... verify instead that DAO calls entity manasger?
 * 
 * verify what else?
 * 
 * coverage:
...
public class TestDaos {
	...
	public static void beforeClass() throws IOException, SQLException {
		...
		emf = Persistence.createEntityManagerFactory("picante-entities-test",
				props);

		// these properties could be set directly in persistence.xml,
		// but the password cannot be retrieved in plain-text from
	...
	private static Properties loadProperties() throws IOException {
		...
		properties.load(TestDaos.class.getClassLoader()
